...
//    std::vector<cv::Rect> regression_box_;
    ...
    vector<vector<float>> feature_list_;
    vector<int> name_list_;
    std::vector<float> feature_1_;
    std::vector<float> feature_2_;

    //paramter for the threshold
    int minSize_ = 21;
    float factor_ = 0.709;
    float similarity_threshold = 1.012;
    float threshold_[3] = {0.85, 0.98, 0.92};
    float threshold_NMS_ = 0.5;
    float threshold_scene_diff_ = 1;
